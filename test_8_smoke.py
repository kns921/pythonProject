...
burger_button = driver.find_element(By.XPATH, '//button[@id="react-burger-menu-btn"]')
driver.execute_script("arguments[0].click();", burger_button)



# size = burger_button.size
# print(f"Ширина: {size['width']}, Высота: {size['height']}")
# driver.execute_script("arguments[0].style.display = 'block';", burger_button)
# driver.execute_script("arguments[0].click();", burger_button)
#
# # Screen Autorization
